...
app.controller('cashierCtrl', ['$scope', '$state', '$http', '$rootScope', 'qbhttp', function($scope, $state, $http, $rootScope, qbhttp) {

    var aid=sessionStorage.getItem("aid");
    var tType= 1;  //1.用户 2.商户 3.代理商
    $scope.params = {
        aid: aid,
        tType:tType,
        searchStr: ''
    ...
    qbhttp.post(path,  $scope.params, function(res) {
        ...
        dom.bootstrapTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    formatter: function(value, row, index) {
                        if(row.drawStatus=="3"){
                            return '<button class="btn btn-xs btn-primary" id="pass">通过</button>'
                        }else {
                            return "--"
                        }
                    },
