...
/**
 * HTTP请求客户端操作类，基于rg.apache.http.client包4.4.x版本实现
 */
public final class HttpHelper {
    ...
    public static void post(String url, String paramData,
                            ResponseCallback callback,HashMap<String,String> headers) {
        post(url, paramData, null, callback,headers);
    }

    public static Rst<Object> post(String url, String paramData) {
        final Rst<Object> response = new Rst<>();
        post(url, paramData, new ResponseCallback() {
            ...
            public void onResponse(int resultCode, String resultJson) {
                if (200 == resultCode) {
                   ...
                   response.setCode(Const.Code.REQUEST_ERROR);
    ...
    public static Rst<Object> post(String url, String paramData,HashMap<String,String> headers) {
        final Rst<Object> response = new Rst<>();
        post(url, paramData, new ResponseCallback() {
            @Override
            public void onResponse(int resultCode, String resultJson) {
    ...
    public static void post(String url, String paramData, List<File> fileList,
                            ResponseCallback callback) {
        doRequest(RequestMethod.POST, url, paramData, fileList, callback,null);
    }
    public static void post(String url, String paramData, List<File> fileList,
                            ResponseCallback callback,HashMap<String,String> headers) {
        doRequest(RequestMethod.POST, url, paramData, fileList, callback,headers);
    }


    public static Rst<Object> post(String url, String paramData, List<File> fileList) {
        final Rst<Object> response = new Rst<>();
    ...
    public static void get(String url, Map<String, String> paramMap, ResponseCallback callback) {
        ...
        doRequest(RequestMethod.GET, url, paramData, null, callback,null);
    }
     ...
     *                 第二个为resultJson,即响应回来的数据报文
     */
    public static void get(String url, Map<String, String> paramMap, ResponseCallback callback, HashMap<String,String> headers) {
        String paramData = null;
        if (null != paramMap && !paramMap.isEmpty()) {
            StringBuilder buffer = new StringBuilder();
            //根据传进来的参数拼url后缀- -!
        ...
        doRequest(RequestMethod.GET, url, paramData, null, callback,headers);
    }

    public static Rst<Object> get(String url,HashMap<String,String> headers) {
        final Rst<Object> response = new Rst<>();
    ...
    public static Rst<Object> get(String url) {
        final Rst<Object> response = new Rst<>();
        doRequest(RequestMethod.GET, url, null, null, new ResponseCallback() {
            @Override
            public void onResponse(int resultCode, String resultJson) {
    ...
    private static void doRequest(final RequestMethod method, final String url,
                                  final String paramData, final List<File> fileList, final ResponseCallback callback,Map<String,String> headers) {
        //如果url没有传入，则直接返回
